...
![Nodejs](https://img.shields.io/github/v/release/nodejs/node?logo=node.js&label=Node%20JS&color=green)
![Reactjs](https://img.shields.io/github/v/release/facebook/react?logo=react&label=React%20JS&color=61dafb)
![Expressjs](https://img.shields.io/github/v/release/expressjs/express?logo=express&label=Express%20JS&color=lightgreen)
![Nestjs](https://img.shields.io/badge/Nest_JS-v10.3.2-red?logo=nestjs)
![Nextjs](https://img.shields.io/github/v/release/vercel/next.js?logo=nextdotjs&label=Next%20JS&color=black)
![Angular](https://img.shields.io/github/v/release/angular/angular?logo=angular&label=Angular&color=dd0031)
![Bootstrap](https://img.shields.io/badge/Bootstrap-v5.3.0-purple?logo=bootstrap&logoColor=white)
![Tailwind](https://img.shields.io/github/v/release/tailwindlabs/tailwindcss?logo=tailwindcss&label=Tailwind&color=06b6d4)
...
![Docker](https://img.shields.io/github/v/release/docker/docker?logo=docker&label=Docker&color=blue)
